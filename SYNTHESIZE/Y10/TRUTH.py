...
def main(tag, name, number, folder):
    ...
    # Bin
    with h5py.File(os.path.join(summarize_folder, '{}/{}/LENS/LENS0/TRUTH.hdf5'.format(tag, name)), 'r') as file:
        bin_lens_size = file['meta']['bin_size'][...]
    
    with h5py.File(os.path.join(summarize_folder, '{}/{}/SOURCE/SOURCE0/TRUTH.hdf5'.format(tag, name)), 'r') as file:
    ...
    with h5py.File(os.path.join(synthesize_folder, '{}/{}/TRUTH.hdf5'.format(tag, name)), 'w') as file:
