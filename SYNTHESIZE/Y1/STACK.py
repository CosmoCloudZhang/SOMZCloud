...
def main(tag, number, folder):
    ...
    for n in range(number + 1):
        ...
        with h5py.File(os.path.join(summarize_folder, '{}/LENS/LENS{}/STACK.hdf5'.format(tag, n)), 'r') as file:
    ...
    for n in range(number + 1):
        ...
        with h5py.File(os.path.join(summarize_folder, '{}/SOURCE/SOURCE{}/STACK.hdf5'.format(tag, n)), 'r') as file:
    ...
    for factor, label in zip(factor_list, label_list):
        ...
        with h5py.File(os.path.join(synthesize_folder, '{}/STACK_{}.hdf5'.format(tag, label)), 'w') as file:
