...
def main(tag, number, folder):
    '''
    Fiducial of the spectroscopic redshift distributions of the lens and source samples
    ...
    for n in range(number + 1):
        ...
        with h5py.File(os.path.join(summarize_folder, '{}/LENS/LENS{}/FIDUCIAL.hdf5'.format(tag, n)), 'r') as file:
    ...
    for n in range(number + 1):
        ...
        with h5py.File(os.path.join(summarize_folder, '{}/SOURCE/SOURCE{}/FIDUCIAL.hdf5'.format(tag, n)), 'r') as file:
