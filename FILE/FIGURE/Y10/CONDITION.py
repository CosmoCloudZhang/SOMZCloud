...
def main(tag, index, folder):
    ...
    for m in range(bin_size):
        ...
        plot[m, 0].text(x=2.0, y=10.0, s=r'$\mathrm{Bin} \, ' + r'{}$'.format(m + 1), fontsize=20)
    ...
    for m in range(bin_size):
        ...
        plot[m, 1].text(x=2.0, y=10.0, s=r'$\mathrm{Bin} \, ' + r'{}$'.format(m + bin_size + 1), fontsize=20)
    ...
    for m in range(bin_size):
        ...
        plot[m, 2].text(x=2.0, y=10.0, s=r'$\mathrm{Bin} \, ' + r'{}$'.format(m + 1), fontsize=20)
