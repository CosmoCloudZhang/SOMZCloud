...
def main(tag, folder):
    ...
    color_list_source = ['darkmagenta', 'darkblue', 'darkgreen', 'darkorange', 'darkred']
    color_list_lens = ['darkmagenta', 'magenta', 'darkblue', 'blue', 'darkgreen', 'green', 'darkorange', 'orange', 'darkred', 'red']
    ...
    for m in range(bin_lens_size):
        ...
        plot[0].plot(z_grid, numpy.transpose(fzb_lens[:, m, :]), color = color_list_lens[m], linewidth = 0.04, alpha = 0.04)
        
        plot[0].plot(z_grid, numpy.mean(fzb_lens[:, m, :], axis=0), color = color_list_lens[m], linewidth = 5.0, label=r'$m = {:.0f}$'.format(m + 1))
    ...
    for m in range(bin_source_size):
        ...
        plot[1].plot(z_grid, numpy.transpose(fzb_source[:, m, :]), color = color_list_source[m], linewidth = 0.04, alpha = 0.04)
        
        plot[1].plot(z_grid, numpy.mean(fzb_source[:, m, :], axis=0), color = color_list_source[m], linewidth = 5.0)
    ...
    for m in range(bin_lens_size):
        ...
        plot[0].plot(z_grid, numpy.transpose(histogram_lens[:, m, :]), color = color_list_lens[m], linewidth = 0.04, alpha = 0.04)
        
        plot[0].plot(z_grid, numpy.mean(histogram_lens[:, m, :], axis=0), color = color_list_lens[m], linewidth = 5.0, label=r'$m = {:.0f}$'.format(m + 1))
    ...
    for m in range(bin_source_size):
        ...
        plot[1].plot(z_grid, numpy.transpose(histogram_source[:, m, :]), color = color_list_source[m], linewidth = 0.04, alpha = 0.04)
        
        plot[1].plot(z_grid, numpy.mean(histogram_source[:, m, :], axis=0), color = color_list_source[m], linewidth = 5.0)
    ...
    for m in range(bin_lens_size):
        ...
        plot[0].plot(z_grid, numpy.transpose(som_lens[:, m, :]), color = color_list_lens[m], linewidth = 0.04, alpha = 0.04)
        
        plot[0].plot(z_grid, numpy.mean(som_lens[:, m, :], axis=0), color = color_list_lens[m], linewidth = 5.0, label=r'$m = {:.0f}$'.format(m + 1))
    ...
    for m in range(bin_source_size):
        ...
        plot[1].plot(z_grid, numpy.transpose(som_source[:, m, :]), color = color_list_source[m], linewidth = 0.04, alpha = 0.04)
        
        plot[1].plot(z_grid, numpy.mean(som_source[:, m, :], axis=0), color = color_list_source[m], linewidth = 5.0)
