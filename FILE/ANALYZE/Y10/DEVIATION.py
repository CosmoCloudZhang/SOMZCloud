...
def main(tag, folder):
    ...
    for label in label_list:
        ...
        for m in range(bin_size):
            ...
            plot[m, 1].hist(som_deviation_lens[:, m + bin_size], bins=size, range=(histogram_scatter_lens[m + bin_size] - lens_range[m], histogram_scatter_lens[m + bin_size] + lens_range[m]), color='darkblue', density=True, histtype='step', linewidth=2.0, linestyle='-')
            
            plot[m, 1].hist(model_deviation_lens[:, m + bin_size], bins=size, range=(histogram_scatter_lens[m + bin_size] - lens_range[m], histogram_scatter_lens[m + bin_size] + lens_range[m]), color='darkgreen', density=True, histtype='step', linewidth=2.0, linestyle='-')
            
            plot[m, 1].hist(product_deviation_lens[:, m + bin_size], bins=size, range=(histogram_scatter_lens[m + bin_size] - lens_range[m], histogram_scatter_lens[m + bin_size] + lens_range[m]), color='darkorange', density=True, histtype='step', linewidth=2.0, linestyle='-')
            
            plot[m, 1].hist(fiducial_deviation_lens[:, m + bin_size], bins=size, range=(histogram_scatter_lens[m + bin_size] - lens_range[m], histogram_scatter_lens[m + bin_size] + lens_range[m]), color='darkred', density=True, histtype='step', linewidth=2.0, linestyle='-')
        ...
        for m in range(bin_size):
            plot[m, 2].hist(som_deviation_source[:, m], bins=size, range=(histogram_scatter_source[m] - source_range[m], histogram_scatter_source[m] + source_range[m]), color='darkblue', density=True, histtype='step', linewidth=2.0, linestyle='-')
            
            plot[m, 2].hist(model_deviation_source[:, m], bins=size, range=(histogram_scatter_source[m] - source_range[m], histogram_scatter_source[m] + source_range[m]), color='darkgreen', density=True, histtype='step', linewidth=2.0, linestyle='-')
            
            plot[m, 2].hist(product_deviation_source[:, m], bins=size, range=(histogram_scatter_source[m] - source_range[m], histogram_scatter_source[m] + source_range[m]), color='darkorange', density=True, histtype='step', linewidth=2.0, linestyle='-')
            
            plot[m, 2].hist(fiducial_deviation_source[:, m], bins=size, range=(histogram_scatter_source[m] - source_range[m], histogram_scatter_source[m] + source_range[m]), color='darkred', density=True, histtype='step', linewidth=2.0, linestyle='-')
            ...
            plot[m, 2].set_xlabel(r'$\langle \varsigma \rangle$')
