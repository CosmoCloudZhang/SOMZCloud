...
def main(tag, label, folder):
    ...
    for m in range(bin_size):
        ...
        plot[m, 1].text(x=histogram_scatter_lens[m + bin_size] - range_lens[m] * 0.80, y=250, s=r'$\delta^\mathrm{SOM}_{\bar{\zeta}} = ' + r'{:.3f}$'.format(som_delta_lens[m + bin_size]), fontsize=15, color='darkblue')
        
        plot[m, 1].text(x=histogram_scatter_lens[m + bin_size] - range_lens[m] * 0.80, y=100, s=r'$\delta^\mathrm{Model}_{\bar{\zeta}} = ' + r'{:.3f}$'.format(model_delta_lens[m + bin_size]), fontsize=15, color='darkgreen')
        
        plot[m, 1].text(x=histogram_scatter_lens[m + bin_size] + range_lens[m] * 0.24, y=250, s=r'$\delta^\mathrm{Product}_{\bar{\zeta}} = ' + r'{:.3f}$'.format(product_delta_lens[m + bin_size]), fontsize=15, color='darkorange')
        
        plot[m, 1].text(x=histogram_scatter_lens[m + bin_size] + range_lens[m] * 0.24, y=100, s=r'$\delta^\mathrm{Fiducial}_{\bar{\zeta}} = ' + r'{:.3f}$'.format(fiducial_delta_lens[m + bin_size]), fontsize=15, color='darkred')
    ...
    for m in range(bin_size):
        ...
        plot[m, 2].text(x=histogram_scatter_source[m] - range_source[m] * 0.80, y=250, s=r'$\delta^\mathrm{SOM}_{\bar{\zeta}} = ' + r'{:.3f}$'.format(som_delta_source[m]), fontsize=15, color='darkblue')
        
        plot[m, 2].text(x=histogram_scatter_source[m] - range_source[m] * 0.80, y=100, s=r'$\delta^\mathrm{Model}_{\bar{\zeta}} = ' + r'{:.3f}$'.format(model_delta_source[m]), fontsize=15, color='darkgreen')
        
        plot[m, 2].text(x=histogram_scatter_source[m] + range_source[m] * 0.24, y=250, s=r'$\delta^\mathrm{Product}_{\bar{\zeta}} = ' + r'{:.3f}$'.format(product_delta_source[m]), fontsize=15, color='darkorange')
        
        plot[m, 2].text(x=histogram_scatter_source[m] + range_source[m] * 0.24, y=100, s=r'$\delta^\mathrm{Fiducial}_{\bar{\zeta}} = ' + r'{:.3f}$'.format(fiducial_delta_source[m]), fontsize=15, color='darkred')
