...
def plot(bin_datasets, test_datasets, input_datasets, train_datasets, augmentation_datasets):
    ...
    plot.hist(z_input, bins=z_bin, linewidth=1.0, density=True, histtype='step', color='darkred', label=r'$\mathrm{selection}$')
    ...
    plot.hist(z_train, bins=z_bin, linewidth=1.0, density=True, histtype='step', color='darkblue', label=r'$\mathrm{combination}$')
    ...
    plot.text(3.0, 15.0, r'$\mathrm{selection}$')
    ...
    plot.text(3.0, 15.0, r'$\mathrm{combination}$')
