...
def plot_figure(index, folder):
    ...
    plot.text(-1.8, 16.5, r'$\mathrm{application}$')
    ...
    plot.text(-1.8, 16.5, r'$\mathrm{selection}$')
    ...
    plot.text(-1.8, 16.5, r'$\mathrm{augmentation}$')
    ...
    plot.text(-1.8, 16.5, r'$\mathrm{combination}$')
