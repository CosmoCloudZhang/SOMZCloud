...
def main(path, index):
    ...
    for m in range(bin_size):
        select_name = os.path.join(data_path, 'SOM/SOURCE/SOURCE{}/SELECT{}.hdf5'.format(index, m + 1))
        cell_name = os.path.join(data_path, 'SOM/SOURCE/SOURCE{}/SOM_CELLID{}.hdf5'.format(index, m + 1))
        cluster_name = os.path.join(data_path, 'SOM/SOURCE/SOURCE{}/SOM_CELL_FILE{}.hdf5'.format(index, m + 1))
        ...
        with h5py.File(os.path.join(data_path, 'SOM/SOURCE/SOURCE{}/SOM_SUMMARIZE_SELECT{}.hdf5'.format(index, m + 1)), 'w') as file:
