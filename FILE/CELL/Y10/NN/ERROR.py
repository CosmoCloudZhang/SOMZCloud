...
def main(tag, name, type, label, folder):
    ...
    bin_lens_size, bin_lens_size, ell_size = cell_shift_error.shape
    bin_lens_size, bin_lens_size, ell_size = cell_data_error.shape
    cell_size = bin_lens_size * (1 + bin_lens_size) // 2
