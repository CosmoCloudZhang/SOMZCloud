...
def main(tag, number, folder):
    '''
    FZB ensemble of the lens samples
    ...
    for n in range(number):
        ...
        with h5py.File(os.path.join(fzb_folder, '{}/LENS/LENS{}/SUMMARIZE.hdf5'.format(tag, n + 1)), 'r') as file:
            data[n, :, :, :] = file['sample'][...]
    ...
    with h5py.File(os.path.join(ensemble_folder, '{}/LENS/FZB.hdf5'.format(tag)), 'w') as file:
