...
def main(path, index):
    ...
    os.makedirs(os.path.join(data_path, 'ENSEMBLE/LENS/LENS{}'.format(index)), exist_ok=True)
    ...
    for m in range(bin_size):
        som_cell_name = os.path.join(data_path, 'SOM/LENS/LENS{}/SOM_CELLID{}.hdf5'.format(index, m + 1))
        fzb_select_name = os.path.join(data_path, 'FZB/LENS/LENS{}/FZB_SELECT{}.hdf5'.format(index, m + 1))
        som_cluster_name = os.path.join(data_path, 'SOM/LENS/LENS{}/SOM_CELL_FILE{}.hdf5'.format(index, m + 1))
        ...
        # Save the data
        with h5py.File(os.path.join(data_path, 'ENSEMBLE/LENS/LENS{}/SINGLE{}.hdf5'.format(index, m + 1)), 'w') as file:
