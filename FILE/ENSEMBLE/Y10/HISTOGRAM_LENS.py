...
def main(tag, number, folder):
    ...
    for n in range(number):
        ...
        with h5py.File(os.path.join(fzb_folder, '{}/LENS/LENS{}/HISTOGRAM.hdf5'.format(tag, n + 1)), 'r') as file:
            data[n, :, :, :] = file['sample'][...]
    ...
    with h5py.File(os.path.join(ensemble_folder, '{}/LENS/HISTOGRAM.hdf5'.format(tag)), 'w') as file:
