...
def main(tag, number, folder):
    '''
    Model of the photometric redshift distributions of the lens and source samples
    ...
    for factor, label in zip(factor_list, label_list):
        ...
        with h5py.File(os.path.join(synthesize_folder, '{}/MODEL_{}.hdf5'.format(tag, label)), 'w') as file:
...
if __name__ == '__main__':
    # Input
    PARSE = argparse.ArgumentParser(description='Synthesize Model')
