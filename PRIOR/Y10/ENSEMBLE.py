...
def plot_ensemble(z_grid, select_lens, select_source, bin_lens_size, bin_source_size):
    ...
    color_lens_list = ['hotpink','darkmagenta', 'darkorchid', 'darkblue', 'deepskyblue', 'darkcyan', 'darkgoldenrod', 'darkorange', 'darksalmon', 'darkred']
    ...
    plot[1].text(x=1.6, y=3.0, s=r'$\mathrm{Source}$', fontsize=25)
