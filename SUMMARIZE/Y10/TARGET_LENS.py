...
def main(tag, index, folder):
    '''
    Target of the spectroscopic redshifts of the lens samples
    ...
    # Save
    with h5py.File(os.path.join(summarize_folder, '{}/LENS/LENS{}/TARGET.hdf5'.format(tag, index)), 'w') as file:
