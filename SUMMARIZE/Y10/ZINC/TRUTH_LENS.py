        ...
        if target_size > 0 and reference_size > 0:
            ...
            for n in range(data_size):
                ...
                if numpy.sum(filter_data) > 0:
                    ...
                    bias = ((application_cluster_z_phot_data - restriction_cluster_z_spec_data) / (1 + restriction_cluster_z_phot_data))[filter_data]
...
if __name__ == '__main__':
    # Input
    PARSE = argparse.ArgumentParser(description='Summarize Bound Truth Lens')
