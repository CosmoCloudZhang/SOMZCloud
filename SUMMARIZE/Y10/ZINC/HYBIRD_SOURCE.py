...
def main(tag, name, index, folder):
    ...
    # Save
    with h5py.File(os.path.join(summarize_folder, '{}/{}/SOURCE/SOURCE{}/PRODUCT.hdf5'.format(tag, name, index)), 'w') as file:
...
if __name__ == '__main__':
    # Input
    PARSE = argparse.ArgumentParser(description='Summarize Bound Product Source')
