...
def main(tag, name, index, folder):
    '''
    Stack summarize of the lens samples
    ...
    for m in range(bin_lens_size):
        ...
        z_pdf = estimator['data']['yvals'][...][target, :]
    ...
    # Save
    with h5py.File(os.path.join(summarize_folder, '{}/{}/LENS/LENS{}/STACK.hdf5'.format(tag, name, index)), 'w') as file:
...
if __name__ == '__main__':
    # Input
    PARSE = argparse.ArgumentParser(description='Summarize Gold Stack Lens')
