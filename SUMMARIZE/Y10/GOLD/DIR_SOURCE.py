...
def main(tag, name, index, folder):
    ...
    with h5py.File(os.path.join(compare_folder, '{}/SOURCE/SOURCE{}/TARGET.hdf5'.format(tag, index)), 'r') as file:
    ...
    with h5py.File(os.path.join(compare_folder, '{}/SOURCE/SOURCE{}/REFERENCE.hdf5'.format(tag, index)), 'r') as file:
...
if __name__ == '__main__':
    # Input
    PARSE = argparse.ArgumentParser(description='Summarize Fiducial DIR Source')
