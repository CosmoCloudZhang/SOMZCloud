...
def main(tag, name, index, folder):
    ...
    with h5py.File(os.path.join(model_folder, '{}/LENS/LENS{}/REFERENCE.hdf5'.format(tag, index)), 'r') as file:
        ...
        reference_lens = reference_lens & (rank == 0)
    ...
    for m in range(bin_lens_size):
        ...
        # Degradation
        degradation_z_phot_reference = combination_z_phot[reference]
        degradation_z_spec_reference = combination_redshift[reference]
        degradation_cell_id_reference = combination_cell_id[reference]
...
if __name__ == '__main__':
    # Input
    PARSE = argparse.ArgumentParser(description='Summarize Silver DIR Lens')
