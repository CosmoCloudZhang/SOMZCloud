...
def main(tag, label, index, folder):
    ...
    os.makedirs(os.path.join(summarize_folder, '{}/{}/SOURCE/'.format(label, tag)), exist_ok=True)
    os.makedirs(os.path.join(summarize_folder, '{}/{}/SOURCE/SOURCE{}'.format(label, tag, index)), exist_ok=True)
    ...
    with h5py.File(os.path.join(constrain_folder, '{}/SOURCE/SOURCE{}/REFERENCE.hdf5'.format(tag, index)), 'r') as file:
    ...
    # Save
    with h5py.File(os.path.join(summarize_folder, '{}/{}/SOURCE/SOURCE{}/DIR.hdf5'.format(label, tag, index)), 'w') as file:
