...
def main(tag, label, index, folder):
    ...
    # Save
    with h5py.File(os.path.join(summarization_folder, '{}/{}/SOURCE/SOURCE{}/STACK.hdf5'.format(label, tag, index)), 'w') as file:
...
if __name__ == '__main__':
    # Input
    PARSE = argparse.ArgumentParser(description='Summarize Copper Stack Source')
