...
def main(tag, index, folder):
    '''
    Plot the figures of the baseline quantile
    ...
    figure.savefig(os.path.join(figure_folder, '{}/BASELINE/FIGURE{}.pdf'.format(tag, index)), format='pdf', bbox_inches='tight', dpi=512)
    pyplot.close(figure)
