...
def main(tag, number, folder):
    ...
    plot.fill_between(x=numpy.linspace(z1_average_lens, z2_average_lens, average_size_lens + 1), y1=numpy.zeros(average_size_lens + 1), y2=numpy.ones(average_size_lens + 1) * 0.02, color='grey', alpha=0.5, rasterized=True)
    ...
    plot.errorbar(x=z_average_lens, y=numpy.median(compare_sigma_lens, axis=0), yerr=[numpy.median(compare_sigma_lens, axis=0) - numpy.quantile(compare_sigma_lens, 0.16, axis=0), numpy.quantile(compare_sigma_lens, 0.84, axis=0) - numpy.median(compare_sigma_lens, axis=0)], color='darkblue', linestyle='-', linewidth=2.5, marker='s', markersize=10, capsize=5, capthick=2.5, alpha=0.8, label=r'$\mathtt{Application} \, \mathrm{trained \, on} \, \mathtt{Degradation}$', rasterized=True)
    ...
    plot.errorbar(x=z_average_lens, y=numpy.median(compare_fraction_lens, axis=0), yerr=[numpy.median(compare_fraction_lens, axis=0) - numpy.quantile(compare_fraction_lens, 0.16, axis=0), numpy.quantile(compare_fraction_lens, 0.84, axis=0) - numpy.median(compare_fraction_lens, axis=0)], color='darkblue', linestyle='-', linewidth=2.5, marker='s', markersize=10, capsize=5, capthick=2.5, alpha=0.8, label=r'$\mathtt{Application} \, \mathrm{trained \, on} \, \mathtt{Degradation}$', rasterized=True)
    ...
    plot.errorbar(x=z_average_lens, y=numpy.median(compare_rate_lens, axis=0), yerr=[numpy.median(compare_rate_lens, axis=0) - numpy.quantile(compare_rate_lens, 0.16, axis=0), numpy.quantile(compare_rate_lens, 0.84, axis=0) - numpy.median(compare_rate_lens, axis=0)], color='darkblue', linestyle='-', linewidth=2.5, marker='s', markersize=10, capsize=5, capthick=2.5, alpha=0.8, label=r'$\mathtt{Application} \, \mathrm{trained \, on} \, \mathtt{Degradation}$', rasterized=True)
    ...
    plot.fill_between(x=numpy.linspace(z1_average_source, z2_average_source, average_size_source + 1), y1=numpy.ones(average_size_source + 1) * -0.03, y2=numpy.ones(average_size_source + 1) * +0.03, color='grey', alpha=0.5, rasterized=True)
    ...
    plot.errorbar(x=z_average_source, y=numpy.median(compare_bias_source, axis=0), yerr=[numpy.median(compare_bias_source, axis=0) - numpy.quantile(compare_bias_source, 0.16, axis=0), numpy.quantile(compare_bias_source, 0.84, axis=0) - numpy.median(compare_bias_source, axis=0)], color='darkblue', linestyle='-', linewidth=2.5, marker='s', markersize=10, capsize=5, capthick=2.5, alpha=0.8, label=r'$\mathtt{Application} \, \mathrm{trained \, on} \, \mathtt{Degradation}$', rasterized=True)
    ...
    plot.fill_between(x=numpy.linspace(z1_average_source, z2_average_source, average_size_source + 1), y1=numpy.zeros(average_size_source + 1), y2=numpy.ones(average_size_source + 1) * 0.03, color='grey', alpha=0.5, rasterized=True)
    ...
    plot.errorbar(x=z_average_source, y=numpy.median(compare_sigma_source, axis=0), yerr=[numpy.median(compare_sigma_source, axis=0) - numpy.quantile(compare_sigma_source, 0.16, axis=0), numpy.quantile(compare_sigma_source, 0.84, axis=0) - numpy.median(compare_sigma_source, axis=0)], color='darkblue', linestyle='-', linewidth=2.5, marker='s', markersize=10, capsize=5, capthick=2.5, alpha=0.8, label=r'$\mathtt{Application} \, \mathrm{trained \, on} \, \mathtt{Degradation}$', rasterized=True)
    ...
    plot.errorbar(x=z_average_source, y=numpy.median(compare_fraction_source, axis=0), yerr=[numpy.median(compare_fraction_source, axis=0) - numpy.quantile(compare_fraction_source, 0.16, axis=0), numpy.quantile(compare_fraction_source, 0.84, axis=0) - numpy.median(compare_fraction_source, axis=0)], color='darkblue', linestyle='-', linewidth=2.5, marker='s', markersize=10, capsize=5, capthick=2.5, alpha=0.8, label=r'$\mathtt{Application} \, \mathrm{trained \, on} \, \mathtt{Degradation}$', rasterized=True)
    ...
    plot.errorbar(x=z_average_source, y=numpy.median(compare_rate_source, axis=0), yerr=[numpy.median(compare_rate_source, axis=0) - numpy.quantile(compare_rate_source, 0.16, axis=0), numpy.quantile(compare_rate_source, 0.84, axis=0) - numpy.median(compare_rate_source, axis=0)], color='darkblue', linestyle='-', linewidth=2.5, marker='s', markersize=10, capsize=5, capthick=2.5, alpha=0.8, label=r'$\mathtt{Application} \, \mathrm{trained \, on} \, \mathtt{Degradation}$', rasterized=True)
    ...
    plot.errorbar(x=z_average_source, y=numpy.median(compare_divergence_source, axis=0), yerr=[numpy.median(compare_divergence_source, axis=0) - numpy.quantile(compare_divergence_source, 0.16, axis=0), numpy.quantile(compare_divergence_source, 0.84, axis=0) - numpy.median(compare_divergence_source, axis=0)], color='darkblue', linestyle='-', linewidth=2.5, marker='s', markersize=10, capsize=5, capthick=2.5, alpha=0.8, label=r'$\mathtt{Application} \, \mathrm{trained \, on} \, \mathtt{Degradation}$', rasterized=True)
