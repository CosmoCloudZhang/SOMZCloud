...
def main(tag, name, label, folder):
    ...
    variance = numpy.diag(covariance)[0: cell_tt_size + cell_te_size]
    ...
    figure.savefig(os.path.join(value_folder, '{}/DOUBLE/{}/{}.pdf'.format(tag, name, label)), bbox_inches='tight', dpi=512)
    pyplot.close(figure)
